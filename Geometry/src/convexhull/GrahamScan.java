...
//		double area2 = (b.x - a.x) * (c.y - a.y) - (b.y - a.y) * (c.x - a.x);
		...
		double area2 = (a.x * (b.y - c.y)) - (b.x * (a.y - c.y)) + (c.x * (a.y - b.y));
		if (area2 < 0)

			return -1; // c in clockwise of a-b line

		else if (area2 > 0)

			return +1; // c in counter-clockwise of a-b line

		else

			return 0; // c in co-linear of a-b line
...
//		list.add(new Point2D(7, 5));
//		list.add(new Point2D(10, 5));
//		list.add(new Point2D(15, 15));
//		list.add(new Point2D(8, 15));
//		list.add(new Point2D(7, 20));
//		list.add(new Point2D(3, 13));
//		list.add(new Point2D(5, 1));
//		
//		
//		
//		Point2D[] pArr = list.toArray(new Point2D[list.size()]);
//		
...
//		}
//		System.out.println();
//		Arrays.sort(pArr, 1, list.size(), pArr[0].POLAR_ORDER);
//
//		for(int i = 0; i < pArr.length; i++){
//			System.out.println(pArr[i]);
//		}
